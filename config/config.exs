...
config :raga, RagaWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: RagaWeb.ErrorHTML, json: RagaWeb.ErrorJSON],
    layout: false
  ],
...
config :raga, groq_api_key: System.get_env("GROQ_API_KEY") || "your_api_key_here"
...
config :raga, Raga.Mailer, adapter: Swoosh.Adapters.Local
